<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowGeneralOfficial.aspx.cs" Inherits="smartvoting.ShowGeneralOfficial" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;<br />
    ...
    <Columns>
        <asp:BoundField DataField="PERSON_ID" HeaderText="TC" />
        <asp:BoundField DataField="PERSON_NAME" HeaderText="Name" />
        <asp:BoundField DataField="PERSON_SURNAME" HeaderText="Surname" />
        <asp:BoundField DataField="DUTY_NUMBER" HeaderText="Duty No" />
        <asp:BoundField DataField="DUTY_STARTING_DATE" HeaderText="Start Date" />
        <asp:BoundField DataField="DUTY_ENDING_DATE" HeaderText="End Date" />
        <asp:BoundField DataField="PERSON_IS_DEATH" HeaderText="Extra Info" />
    </Columns>
</asp:GridView>
                    </div>
                </div>

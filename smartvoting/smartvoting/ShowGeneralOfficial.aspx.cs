...
{
    public partial class ShowGeneralOfficial : System.Web.UI.Page
    {
        ...
        protected void BtnShow_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT P.PERSON_ID, P.PERSON_NAME, P.PERSON_SURNAME, GODC.DUTY_NUMBER,GODC.DUTY_STARTING_DATE, GODC.DUTY_ENDING_DATE, CASE P.PERSON_IS_DEAD WHEN '1' THEN 'DEAD' ELSE 'ALIVE' END AS PERSON_IS_DEATH FROM GENERALOFFICIAL_DUTY_CONTROL GODC INNER JOIN PERSON P ON P.PERSON_ID = GODC.PERSON_ID WHERE GODC.DUTY_STARTING_DATE > ?startdate AND GODC.DUTY_ENDING_DATE < ?enddate";
